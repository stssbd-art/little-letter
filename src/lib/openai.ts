...
const MIDDLES: Record<LetterFormData["occasion"], string[]> = {
  ...
  wedding: [
    `On your wedding day, I hope the room feels like all the softest parts of your story gathering in one place.`,
    `Wishing you a marriage that feels like home — laughter in the kitchen, patience in the hard bits, and joy that keeps choosing each other.`,
    `Congratulations on saying yes to a life together. May the day sparkle and the years stay kind.`,
    `Here is to rings, vows, and the everyday tenderness that follows. I am so happy for you.`,
    `May your wedding be full of warmth, and your life after it even fuller of good ordinary mornings.`,
    `Love looks good on you two. Celebrating this beginning with a full heart from here.`,
  ],
  graduation: [
    `You did it — the late nights, the nerves, the showing up. Graduation looks excellent on you.`,
    `Caps off to the work you put in. I hope today feels like a proper pause before the next adventure.`,
    `Congratulations on graduating. May the next chapter treat you with curiosity and courage.`,
    `This diploma is paper. The grit behind it is you. I am proud of that version of you.`,
    `Walk across that stage knowing the hard bits counted. You earned every bit of this cheer.`,
    `Graduation is not an ending so much as a brightly lit doorway. Go through it as yourself.`,
  ],
  promotion: [
    `Promotion news! Your effort got seen, and that deserves a proper celebration and a deep breath.`,
    `New title, same excellent you — plus a little more room to grow. Congratulations.`,
    `I am proud of how you showed up for this. May the new role fit with challenge and kindness.`,
    `Look at you leveling up. Enjoy the win before the to-do list gets loud again.`,
    `This promotion is not luck alone — it is consistency meeting an open door. Well done.`,
    `Cheers to bigger responsibility and the quiet confidence that got you here.`,
  ],
  "valentines-day": [
    `Happy Valentine's Day — not the glitter-card kind, the real kind: glad you are in my life.`,
    `On a day built for hearts, mine keeps landing on you. Consider this a soft yes to us.`,
    `Valentine's without the pressure — just affection, written down so you can keep it.`,
    `Whether we are near or far, today I hope you feel chosen, noticed, and warmly liked.`,
    `Chocolate is fine. This letter is me. Happy Valentine's Day.`,
    `A small love note for February: you make ordinary days feel like something worth celebrating.`,
  ],
  "mothers-day": [
    `Happy Mother's Day — thank you for the care that shaped so many soft places in me.`,
    `For all the invisible work and the loud love: today I hope you feel celebrated properly.`,
    `Mother's Day is too small for everything you are, but this note is my attempt anyway.`,
    `Thank you for the patience, the meals, the worry, the cheerleading. I see it.`,
    `Wishing you a day with fewer chores and more of whatever makes you exhale.`,
    `You are loved in the everyday way and the holiday way. Happy Mother's Day.`,
  ],
  "fathers-day": [
    `Happy Father's Day — thank you for the steady presence and the quiet strength I still borrow.`,
    `For the advice, the jokes, the showing up: today I hope you feel how much it mattered.`,
    `Father's Day note, short and true — I am glad you are mine.`,
    `Thank you for teaching me things that still help on ordinary Tuesdays.`,
