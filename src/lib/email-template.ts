...
const THEMES: Record<Occasion, FrameTheme> = {
  ...
  wedding: {
    pageBg: "linear-gradient(180deg,#fffaf0 0%,#faf4e8 50%,#fef3c7 100%)",
    cardBg: "#fffbf7",
    border: "#d4a574",
    shadow: "#f6d58a",
  ...
  graduation: {
    pageBg: "linear-gradient(180deg,#ecfdf5 0%,#faf4e8 50%,#d1fae5 100%)",
    cardBg: "#fffbf2",
    border: "#34d399",
    shadow: "#a7f3d0",
    headerGrad: "linear-gradient(90deg,#6ee7b7,#34d399,#e8b86d)",
  ...
  promotion: {
    pageBg: "linear-gradient(180deg,#fff7ed 0%,#faf4e8 50%,#ffedd5 100%)",
    cardBg: "#fffbf2",
    border: "#fb923c",
    shadow: "#fed7aa",
    headerGrad: "linear-gradient(90deg,#fdba74,#fb923c,#e8b86d)",
    headerInk: "#7c2d12",
    headerSub: "#c2410c",
    badgeBg: "#fff7ed",
    badgeBorder: "#fb923c",
    ...
    tagline: "a promotion cheer with extra sparkle",
    footerIcons: "🚀 ⭐ 💼 ✨ 🥂",
  ...
  "mothers-day": {
    pageBg: "linear-gradient(180deg,#fdf2f8 0%,#faf4e8 50%,#fce7f3 100%)",
    cardBg: "#fffbf7",
    border: "#f9a8d4",
    shadow: "#fbcfe8",
    headerGrad: "linear-gradient(90deg,#f9a8d4,#fb7185,#e8b86d)",
    headerInk: "#831843",
    headerSub: "#9d174d",
    badgeBg: "#fdf2f8",
    badgeBorder: "#f9a8d4",
  ...
  "fathers-day": {
    pageBg: "linear-gradient(180deg,#eff6ff 0%,#faf4e8 50%,#dbeafe 100%)",
    cardBg: "#fffbf2",
    border: "#60a5fa",
    shadow: "#bfdbfe",
    headerGrad: "linear-gradient(90deg,#93c5fd,#60a5fa,#c4a574)",
